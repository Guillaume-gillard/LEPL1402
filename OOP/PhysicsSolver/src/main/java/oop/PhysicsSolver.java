...
public class PhysicsSolver {
    ...
    public static class Slot {
        ...
        public boolean setValue(double value) {
            if (this.hasValue() && this.value == value) return false;
            if (this.hasValue() && this.value != value) throw new RuntimeException();
            this.value = value;
            return true;
        }
    ...
    public static class Multiplication extends Relation {
         ...
         * @return The slot.
         **/
        public Slot getProduct() {return product_;}
        ...
        public boolean update() {
            ...
            if (factor1_.hasValue() && product_.hasValue() && !factor2_.hasValue()){
                factor2_.setValue(product_.getValue()/ factor1_.getValue());
                return true;
            }
            if (factor2_.hasValue() && product_.hasValue() && !factor1_.hasValue()){
